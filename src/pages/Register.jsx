...
const RegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.values(errors).every((error) => error === '')) {
      try {
        const { firstName, lastName, email, password, image, option } = formData;
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <div className="flex flex-col md:flex-row bg-gray-100 rounded-lg shadow-lg p-6">
        ...
        <img  className='object-fill w-full h-full' src="https://img.freepik.com/free-vector/mobile-login-concept-illustration_114360-135.jpg?w=740&t=st=1684136425~exp=1684137025~hmac=05428f0e56fb7b2e4bb04289e1d19bd00add14230443e257e8e4f27c9d0a05db" alt="image" />
        </div>
      ...
      <div className="w-full md:w-1/2 bg-white flex items-center justify-center">
        ...
        <form className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl px-4">
              ...
              <div className="w-1/2 mr-2">
                <input
                  ...
                  className={`w-full border ${errors.firstName ? 'border-red-500' : 'border-gray-300'
                    } rounded-md py-2 px-3 ${errors.firstName ? 'text-red-500' : 'text-gray-700'
                    }`}
                />
                {errors.firstName && (
              ...
              <div className="w-1/2 ml-2">
                <input
                  ...
                  className={`w-full border ${errors.lastName ? 'border-red-500' : 'border-gray-300'
                    } rounded-md py-2 px-3 ${errors.lastName ? 'text-red-500' : 'text-gray-700'
                    }`}
                />
                {errors.lastName && (
          ...
          <div className="mb-4">
            <input
              ...
              className={`w-full border ${errors.email ? 'border-red-500' : 'border-gray-300'
                } rounded-md py-2 px-3 ${errors.email ? 'text-red-500' : 'text-gray-700'
                }`}
            />
          ...
          <div className="mb-4">
            <input
              ...
              className={`w-full border ${errors.password ? 'border-red-500' : 'border-gray-300'
                } rounded-md py-2 px-3 ${errors.password ? 'text-red-500' : 'text-gray-700'
                }`}
            />
            {errors.password && (
          ...
          <div className="mb-4">
            ...
            <p className='my-5'> already an account <Link to={"/login"}><span className='text-blue-800 underline'>sign in </span></Link> </p>
          </div>
        </form>
        </div>
        </div>
